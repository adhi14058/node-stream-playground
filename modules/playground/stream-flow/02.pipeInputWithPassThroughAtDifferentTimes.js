...
function a() {
	pipeline(readStream, new PassThrough(), writeStream1, pipelineHnadler); //first pipeline
	pipeline(readStream, new PassThrough(), writeStream2, pipelineHnadler); //second pipeline
}
...
function b() {
	...
	pipeline(readStream, new PassThrough(), writeStream3, pipelineHnadler); //third pipeline
}
